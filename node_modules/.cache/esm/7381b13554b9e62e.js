let CP,getRow,getColumn,getOpen,getUniqueOpenValues,getOpenExternalWith,formatUpdate,formatSolution,findGroups,R;_54b‍.x([["solveXWing",()=>solveXWing],["solveSwordfish",()=>solveSwordfish],["solveJellyfish",()=>solveJellyfish]]);_54b‍.w("../cellPath",[["cellPath",["CP"],function(v){CP=v}],["getRow",["getRow"],function(v){getRow=v}],["getColumn",["getColumn"],function(v){getColumn=v}],["getOpen",["getOpen"],function(v){getOpen=v}],["getUniqueOpenValues",["getUniqueOpenValues"],function(v){getUniqueOpenValues=v}],["getOpenExternalWith",["getOpenExternalWith"],function(v){getOpenExternalWith=v}]]);_54b‍.w("../solutionObject",[["formatUpdate",["formatUpdate"],function(v){formatUpdate=v}],["formatSolution",["formatSolution"],function(v){formatSolution=v}]]);_54b‍.w("./pairFinder",[["findGroups",["findGroups"],function(v){findGroups=v}]]);_54b‍.w("ramda",[["*",null,function(v){R=v}]]);
...
const solveFish = (fishLen, description) => sudokuGrid => {
  ...
  // curry solveFish into different fish variations
         const solveXWing = solveFish(2, "X-Wing");
         const solveSwordfish = solveFish(3, "Swordfish");
         const solveJellyfish = solveFish(4, "Jellyfish");