...
const followUpOptions = currentAnswer => {
    ...
    prompt.get("option", function(err, result) {
        switch (result.option) {
            case "strategies":
                currentAnswer.solutions.map( sol => _701‍.g.console.log(sol));
                console.log("");
...
const testUserGrid = () => {
    ...
    prompt.get("puzzle", function(err, result) {
        ...
        if (!currentAnswer.valid) {
            ...
            console.log("");
            _701‍.g.console.log(chalk.underline("  Starting Puzzle  "));
            displayGrid(Array.from(currentAnswer.gridString).map(x => JSON.parse(x)));

            console.log("");
            _701‍.g.console.log(chalk.underline("  Results  "));
            ...
            console.log("");
            _701‍.g.console.log(chalk.underline(`  ${currentAnswer.solved ? "Finished" : "Updated"} Puzzle  `));
...
openingMessages.forEach((msg, i) => {
    if (typeof msg === "string") {
        setTimeout( () => _701‍.g.console.log(msg), (700 * i))
    } else {
        setTimeout( () => msg.map(x => _701‍.g.console.log(x)), (700 * i))
    }
});
