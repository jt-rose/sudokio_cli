let getOpen,getRelCell,R;_371‍.x([["isOnly",()=>isOnly],["formatUpdate",()=>formatUpdate],["formatSolution",()=>formatSolution],["filterBest",()=>filterBest],["sortBest",()=>sortBest],["updateRelCell",()=>updateRelCell],["applySolutionSingle",()=>applySolutionSingle],["applySolution",()=>applySolution]]);_371‍.w("./cellPath",[["getOpen",["getOpen"],function(v){getOpen=v}],["getRelCell",["getRelCell"],function(v){getRelCell=v}]]);_371‍.w("ramda",[["*",null,function(v){R=v}]]);
...
// generate object to store cell update info 
       function formatUpdate(index, sudokuGrid, removal, additionalNotes=false) {
...
// format solution object
       function formatSolution(strategy, cellInit, updateCollection, additionalNotes=false) {
...
// pick the best solution from list of those currently possible
       function filterBest(solutionList) {
...
// returns full solutionList, but sorted in order of filterBest results
       const sortBest = (solutionList, sortedList=[]) => {
...
// update the sudokuGrid by applying the solution and returning a new grid
       function applySolutionSingle(sudokuGrid, solution) {
...
// checks if multiple solutions found and apply
       const applySolution = (sudokuGrid, solution) => {
