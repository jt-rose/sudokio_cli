let getOpen,getUniqueOpenValues,includesEach,isOnly,formatUpdate,formatSolution,findGroups;_c62‍.x([["solveHiddenPair",()=>solveHiddenPair],["solveHiddenTriple",()=>solveHiddenTriple],["solveHiddenQuad",()=>solveHiddenQuad]]);_c62‍.w("../cellPath",[["getOpen",["getOpen"],function(v){getOpen=v}],["getUniqueOpenValues",["getUniqueOpenValues"],function(v){getUniqueOpenValues=v}],["includesEach",["includesEach"],function(v){includesEach=v}]]);_c62‍.w("../solutionObject",[["isOnly",["isOnly"],function(v){isOnly=v}],["formatUpdate",["formatUpdate"],function(v){formatUpdate=v}],["formatSolution",["formatSolution"],function(v){formatSolution=v}]]);_c62‍.w("./pairFinder",[["findGroups",["findGroups"],function(v){findGroups=v}]]);
...
// things simple, we will stop with sets of 2, 3, and 4
       const solveHiddenPair = solveHiddenPairings(2);
       const solveHiddenTriple = solveHiddenPairings(3);
       const solveHiddenQuad = solveHiddenPairings(4);