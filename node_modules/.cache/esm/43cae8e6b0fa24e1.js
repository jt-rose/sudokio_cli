let CP,isOnly,formatUpdate,formatSolution,applySolution,solveEach,applyStrats,limitStratsTo,R;_b0f‍.x([["solveXChain",()=>solveXChain],["solveXChainFullGrid",()=>solveXChainFullGrid]]);_b0f‍.w("../cellPath",[["cellPath",["CP"],function(v){CP=v}]]);_b0f‍.w("../solutionObject",[["isOnly",["isOnly"],function(v){isOnly=v}],["formatUpdate",["formatUpdate"],function(v){formatUpdate=v}],["formatSolution",["formatSolution"],function(v){formatSolution=v}],["applySolution",["applySolution"],function(v){applySolution=v}]]);_b0f‍.w("../applyStrats",[["solveEach",["solveEach"],function(v){solveEach=v}],["applyStrats",["applyStrats"],function(v){applyStrats=v}],["limitStratsTo",["limitStratsTo"],function(v){limitStratsTo=v}]]);_b0f‍.w("ramda",[["*",null,function(v){R=v}]]);
