let getOpen,getExternal,getUniqueOpenValues,formatUpdate,formatSolution,findGroups,R;_e40‍.x([["hasSomeButNotAll",()=>hasSomeButNotAll],["solveNakedPair",()=>solveNakedPair],["solveNakedTriple",()=>solveNakedTriple],["solveNakedQuad",()=>solveNakedQuad]]);_e40‍.w("../cellPath",[["getOpen",["getOpen"],function(v){getOpen=v}],["getExternal",["getExternal"],function(v){getExternal=v}],["getUniqueOpenValues",["getUniqueOpenValues"],function(v){getUniqueOpenValues=v}]]);_e40‍.w("../solutionObject",[["formatUpdate",["formatUpdate"],function(v){formatUpdate=v}],["formatSolution",["formatSolution"],function(v){formatSolution=v}]]);_e40‍.w("./pairFinder",[["findGroups",["findGroups"],function(v){findGroups=v}]]);_e40‍.w("ramda",[["*",null,function(v){R=v}]]);
       ...
       function hasSomeButNotAll(arr, findValues) {
...
// things simple, we will stop with sets of 2, 3, and 4
       const solveNakedPair = solveNakedPairings(2);
       const solveNakedTriple = solveNakedPairings(3);
       const solveNakedQuad = solveNakedPairings(4);